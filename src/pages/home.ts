	...
	return layout({
		...
		content: `
			<style>
				...
				.cardx { grid-column: span 4; border-radius:1.25rem; border:1px solid #2A2A3C; background: rgba(26,26,36,.55); padding:1.1rem; transition: transform .16s ease, border-color .16s ease, background .16s ease; }
				.cardx:hover { transform: translateY(-3px); border-color: rgba(108,99,255,.45); background: rgba(26,26,36,.78); }
			...
			<div class="hero">
				<div>
					...
					<div class="row cta fade-in d3">
						<a class="btn btn-primary" href="/authorize?client_id=sapphireauth&response_type=code&redirect_uri=/callback">Get started</a>
						<a class="btn" href="/authorize?client_id=sapphireauth&response_type=code&redirect_uri=/callback">Log in</a>
						<a class="btn" href="/authorize?client_id=sapphireauth&response_type=code&redirect_uri=/callback">Create account</a>
					</div>
				</div>
				...
				<div class="mock fade-in d2" aria-hidden="true">
					<div class="mock-inner">
						<div class="kpi">
							<div class="box"><div class="n">AES‑GCM</div><div class="l">Client-side encryption</div></div>
							<div class="box"><div class="n">R2</div><div class="l">Fast file storage</div></div>
						</div>
						<div class="box" style="border:1px solid #2A2A3C;border-radius:1rem;padding:1rem;background: rgba(15,15,19,.55);">
							<div style="font-weight:800; margin-bottom:.4rem;">Preview</div>
							<div class="small">Images + videos preview instantly. Files stay private per user.</div>
						</div>
						<div class="box" style="border:1px solid #2A2A3C;border-radius:1rem;padding:1rem;background: rgba(15,15,19,.55);">
							<div style="font-weight:800; margin-bottom:.4rem;">Passwords</div>
							<div class="small">Search, favorite, and copy credentials. (UI upgrade in progress.)</div>
						</div>
					</div>
				</div>
			</div>
